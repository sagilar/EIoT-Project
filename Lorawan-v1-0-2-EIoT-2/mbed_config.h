...
#define MBED_CONF_LORA_ADR_ON                                                 0                                                                                                // set by application[*]
#define MBED_CONF_LORA_APPLICATION_EUI                                        { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x01, 0x49, 0x41 }                                               // set by application[*]
#define MBED_CONF_LORA_APPLICATION_KEY                                        { 0x08,0xbc,0x75,0x15,0xe7,0xfe,0x9e,0x93,0x46,0xd2,0x0e,0xde,0x3d,0x2b,0x02,0xf4 }              // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0xc7,0x0e,0x8a,0xde,0x81,0x06,0x34,0xb4 }                                                      // set by application[*]
...
#define MBED_CONF_LORA_PHY                                                    US915                                                                                            // set by application[*]
#define MBED_CONF_LORA_PUBLIC_NETWORK                                         1                                                                                                // set by library:lora
#define MBED_CONF_LORA_TX_MAX_SIZE                                            255                                                                                              // set by application[*]
